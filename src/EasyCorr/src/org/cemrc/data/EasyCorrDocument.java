...
public class EasyCorrDocument {
     ...
     */
	public static void serialize(EasyCorrDocument doc, File file) throws JAXBException, FileNotFoundException {
		JAXBContext contextObj = JAXBContext.newInstance(EasyCorrDocument.class);  
	 ...
	 * @throws JAXBException
	 */
	public static EasyCorrDocument deserialize(File file) throws JAXBException {
		JAXBContext contextObj = JAXBContext.newInstance(EasyCorrDocument.class);  
      
        Unmarshaller jaxbUnmarshaller = contextObj.createUnmarshaller();    
        EasyCorrDocument rv = (EasyCorrDocument) jaxbUnmarshaller.unmarshal(file);
