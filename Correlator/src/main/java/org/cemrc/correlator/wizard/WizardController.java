...
public class WizardController {
	...
	private void buildSteps() throws java.io.IOException {
		...
		FXMLLoader fxmlLoaderStep1 = new FXMLLoader(Correlator.class.getResource("/view/wizard/ImportMapPanel.fxml"));
		Parent step1 = fxmlLoaderStep1.load( );
		m_pages.add((WizardImportMapController)fxmlLoaderStep1.getController());
		
		FXMLLoader fxmlLoaderStep2 = new FXMLLoader(Correlator.class.getResource("/view/wizard/ImportPointsPanel.fxml"));
		Parent step2 = fxmlLoaderStep2.load( );
		m_pages.add((WizardImportPositionsController)fxmlLoaderStep2.getController());

		FXMLLoader fxmlLoaderStep3 = new FXMLLoader(Correlator.class.getResource("/view/wizard/ExportToNavigator.fxml"));
		Parent step3 = fxmlLoaderStep3.load( );
		m_pages.add((WizardExport)fxmlLoaderStep3.getController());
		
		FXMLLoader fxmlLoaderStep4 = new FXMLLoader(Correlator.class.getResource("/view/wizard/FinishPage.fxml"));
